...
def format_data_to_parquet(df, filename):
    try:
    ...
    for table_name in TABLES:
        ...
        if conn:
            ...
            if df is not None:
                ...
                parquet_file = format_data_to_parquet(df, f"{table_name}.parquet")

                if parquet_file:
                    # Upload the Parquet file to GCS
                    upload_to_gcs(GCS_BUCKET_NAME, parquet_file, f"{table_name}.parquet")

...
def save_to_gcs(weather_data_json: str, location_name: str):
    """Save weather data to Google Cloud Storage as CSV in a folder"""
    try:
        ...
        folder_path = f"weather_data/{location_name}"
        filename = f"{folder_path}/{location_name}_daily_weather_{timestamp}.csv"
